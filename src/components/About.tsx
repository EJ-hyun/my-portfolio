...
function About() {
  ...
  const step04PathRef = useRef<SVGPathElement>(null);
  ...
  useEffect(() => {
    ...
    const step04Path = step04PathRef.current;
    const step04PathLength = step04Path?.getTotalLength();
    ...
    if (step04Path) {
      gsap.set(step04Path, {
        strokeDasharray: step04PathLength,
        strokeDashoffset: step04PathLength,
      });
    }
  ...
  return (
    <section
      ref={aboutRef}
      className="pt-80 bg-center bg-cover bg-fixed bg-[url('/assets/images/section02_bg.png')]"
    >
      {/* Step 01 */}
      <div ref={section01Ref} className="flex max-w-7xl mx-auto">
        ...
        <div
          ref={text01Ref}
          className="max-w-2xl mx-auto mt-15 opacity-0 translate-y-5"
        >
          <p className="flex items-end gap-3 mb-6 text-xl text-[#FEB500]">
            <span className="font-accent text-4xl">Web Designer</span>
            Apr.2017~
          </p>
          ...
          <ul className="flex gap-2">
            <li className="flex items-center justify-center py-1 px-3 bg-gray-400 text-white text-base rounded-2xl">
              Photoshop
            </li>
            <li className="flex items-center justify-center py-1 px-3 bg-gray-400 text-white text-base rounded-2xl">
              Illustrator
      ...
      <div
        ref={section02Ref}
        className="relative flex max-w-7xl mx-auto pl-25 -mt-19"
      >
        <div className="">
          <div className="">
            <svg
        ...
        <div
          ref={text02Ref}
          className="absolute left-150 max-w-2xl mx-auto mt-15 opacity-0 translate-y-5"
        >
          <p className="flex items-end gap-3 mb-6 text-xl text-[#FEB500]">
            <span className="font-accent text-4xl">Publisher</span>
            Nov.2020~
          </p>
          <p className="mb-2 text-lg text-white">
      ...
      <div
        ref={section03Ref}
        className="relative flex flex-row-reverse max-w-7xl mx-auto"
      >
        ...
        <div
          ref={text03Ref}
          className="text-left max-w-2xl mx-auto mt-10 opacity-0 translate-y-5"
        >
          <p className="flex items-end gap-3 mb-6 text-xl text-[#FEB500]">
            Mar.2025~
            <span className="font-accent text-4xl">Frontend developer</span>
          </p>
          <p className="mb-2 text-lg text-white">
      ...
      {/* Step 04 */}
      <div ref={section04Ref} className="pb-40">
        <div className="w-full text-center -mt-8">
          <div className="relative w-[1015px] mx-auto h-[85px]">
            <Image
          ...
          <p
            ref={text04Ref}
            className="text-lg text-white mt-10 px-4 opacity-0 translate-y-5"
          >
            웹디자이너로 시작해 퍼블리셔와 프론트엔드를 경험해 오면서, 저는
            하나의 서비스를 만드는 일이 기초부터 구조, <br />
